export default function Footer() {
  return (
    <div className="footer max-w-480 w-full h-61 bg-[#192F59] py-2.25 text-white mt-auto">
      <div className="max-w-400 w-full h-56.5 mx-auto flex items-center gap-45">
        <div className="max-w-98 w-full h-35.75 flex gap-5 ">
          <div className="w-25 h-full flex flex-col justify-between">
            ...
            />
            <ul className="w-full h-17.75 text-sm flex flex-col justify-between font-semibold">
              <li>Địa chỉ</li>
              <li>Điện thoại</li>
              <li>Email</li>
            </ul>
          ...
          <div className="w-55.5 h-full flex flex-col justify-between">
            <div className="h-10.5 text-center flex items-center">
              <h3 className="text-xl font-bold">Website bán sách 4TQ</h3>
            </div>
            <ul className="w-full h-17.75 text-sm flex flex-col justify-between font-medium">
        ...
        <div className="max-w-50 w-full h-36.375 flex flex-col gap-5 px-3.75">
          <div className="w-full">
            <h3 className="uppercase font-bold">Chính sách</h3>
          </div>
          <ul className="w-full h-27 text-sm flex flex-col justify-between font-base">
            <li className="">
