...
const EditUser = () => {
  const [form, setForm] = useState({ name: 'Nguyễn Văn A', email: 'a@example.com', password: '', phone: '0912345678', address: 'Hà Nội', role: 'user' });
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      navigate('/admin/nguoi-dung', { state: { message: 'Sửa người dùng thành công!' } });
    }, 600);
  };
  ...
  return (
    <div className="bg-white">
      ...
      <form className="mx-20 space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col">
          <div className="flex items-center">
            <label className="w-1/4 font-semibold">Mật khẩu:</label>
        ...
        <div className="flex flex-col">
          <div className="flex items-center">
            ...
            <input name="phone" value={form.phone} onChange={handleChange} className="w-3/4 border border-gray-300 p-2 rounded" />
          </div>
        ...
        <div className="flex space-x-2 pt-10">
          <button type="submit" className="w-22 h-10 font-bold bg-yellow-500 hover:opacity-70 text-white rounded">Sửa</button>
