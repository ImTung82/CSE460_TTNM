...
export default function Collection() {
  ...
  return (
    <>
      <Header />
      <div className="max-w-480 w-full max-h-424.5 h-full mb-8">
        <div className="w-full h-14.25  mt-7.5 py-2 ">
          <div className="max-w-332.5 w-full h-full mx-auto flex items-center text-xl">
        ...
        <div className="max-w-332.5 w-full max-h-398 h-full mt-5 mx-auto flex justify-between ">
          <div className="max-w-70 w-full h-46 pt-5 px-5 border rounded-md">
            <div className="w-full px-2">
              <h2 className="uppercase text-3xl">Danh mục</h2>
            </div>
              ...
              {categories.map((cat) => (
                ...
                >
                  <Link
                    ...
                    className={`font-extralight text-base w-full h-full flex items-center transition-colors duration-150 ${
                      categoryKey === cat.key
          ...
          <div className="max-w-257.5 w-full border">
