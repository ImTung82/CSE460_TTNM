...
const App = () => (
  <Routes>
    {/* Admin routes */}
    <Route path="/admin" element={<AdminLayout><div>Đây là trang tổng quan của Bảng điều khiển dành cho quản lý</div></AdminLayout>} />
    ...
    <Route path="/admin/san-pham/sua-dau-sach" element={<AdminLayout><EditBook /></AdminLayout>} />
